\begin{tikzpicture}[remember picture,overlay]
    ...
    %%%%%% LETRAS %%%%%
    \node[anchor=south,right] at ([xshift=-5.55\outermarginwidth, yshift=-.465\paperheight]current page.north) {\selectfont           \color{cw0}\cabin\bfseries\fontsize{74}{74}\selectfont INGENIERÍA};
    \node[anchor=south,right] at ([xshift=-5.65\outermarginwidth, yshift=-.57\paperheight]current page.north) {\selectfont           \color{cw0}\cabin\bfseries\fontsize{74}{74}\selectfont ECONÓMICA};
    \node[anchor=west, font=\cabin\fontsize{23}{23}\selectfont, text=white] at ([xshift=1.5\outermarginwidth, yshift=-1.25\covershift]current page.west) {Probabilidad y teoría de juegos};
    \node[anchor=west, font=\cabin\LARGE, text=black] at ([xshift=-1.5\outermarginwidth, yshift=-2.3\covershift]current page.center) {Antonio M. Mendoza ~$\bullet$~ Gabriel Robles C.};
\end{tikzpicture}
...
\vspace{2cm}
\begin{center}
\scalebox{5.5}{\fontencoding{T1}\fontfamily{pag}\selectfont\textbf{\color{cw0}INGENIERÍA}}\\[8mm]
\scalebox{5.5}{\fontencoding{T1}\fontfamily{pag}\selectfont\textbf{\color{cw2}ECONÓMICA}}\\[2cm]

\begin{tabular}{c} \selectfont\cabin\scalebox{2}{Gabriel Robles} \\[2mm] \selectfont\cabin\scalebox{2}{Contreras} \end{tabular} \hspace{2.5cm} \begin{tabular}{c} \selectfont\cabin\scalebox{2}{Marco Antonio} \\[2mm] \selectfont\cabin\scalebox{2}{Molina Mendoza} \end{tabular}\\[26mm]
